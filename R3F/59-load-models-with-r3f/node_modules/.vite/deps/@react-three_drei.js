...
import "./chunk-HTM3RKXN.js";
import "./chunk-RBP34AY7.js";
import {
  require_react
...
var _a;
var isMac = /Mac/.test((_a = globalThis == null ? void 0 : globalThis.navigator) == null ? void 0 : _a.platform);
var THREE;
var _ORIGIN;
var _AXIS_Y;
var _AXIS_Z;
...
var CameraControls = class _CameraControls extends EventDispatcher2 {
  ...
  fitToBox(box3OrObject, enableTransition, { cover = false, paddingLeft = 0, paddingRight = 0, paddingBottom = 0, paddingTop = 0 } = {}) {
    ...
    const center = bb2.getCenter(_v3B).applyQuaternion(rotation3);
    if (isPerspectiveCamera(this._camera)) {
  ...
  static createBoundingSphere(object3d, out = new THREE.Sphere()) {
    ...
    object3d.traverseVisible((object) => {
      ...
      for (let i2 = 0, l = position2.count; i2 < l; i2++) {
        _v3A.fromBufferAttribute(position2, i2);
...
async function getHls(...args) {
  var _HLSModule2;
  (_HLSModule2 = _HLSModule) !== null && _HLSModule2 !== void 0 ? _HLSModule2 : _HLSModule = await import("./hls-HAVBIVQD.js");
...
function useTrailTexture(config = {}) {
  ...
  const onMove = (0, import_react16.useCallback)((e) => trail.addTouch(e.uv), [trail]);
...
var Center = React78.forwardRef(function Center2({
  ...
  const [center] = React78.useState(() => new Vector3());
...
var ScreenVideoTexture = (0, import_react21.forwardRef)(({
  options = {
    video: true
  },
  ...props
...
var WebcamVideoTexture = (0, import_react22.forwardRef)(({
  constraints = {
    audio: false,
    video: {
      facingMode: "user"
...
var FaceLandmarkerContext = (0, import_react23.createContext)({});
...
var FaceLandmarker = (0, import_react23.forwardRef)(({
  ...
  const faceLandmarker = suspend(async () => {
    ...
    } = await import("./vision_bundle-JBPZP7DM.js");
  ...
  (0, import_react23.useImperativeHandle)(fref, () => faceLandmarker, [faceLandmarker]);
  return React139.createElement(FaceLandmarkerContext.Provider, {
    value: faceLandmarker
  }, children);
});
function useFaceLandmarker() {
  return (0, import_react23.useContext)(FaceLandmarkerContext);
}
...
var FaceControlsContext = (0, import_react24.createContext)({});
var FaceControls = (0, import_react24.forwardRef)(({
  camera,
  videoTexture = {
    start: true
  },
  ...
  const get = useThree((state) => state.get);
  const explCamera = camera || defaultCamera;
  const facemeshApiRef = (0, import_react24.useRef)(null);
  const [target2] = (0, import_react24.useState)(() => new Object3D());
  const [irisRightDirPos] = (0, import_react24.useState)(() => new Vector3());
  const [irisLeftDirPos] = (0, import_react24.useState)(() => new Vector3());
  const [irisRightLookAt] = (0, import_react24.useState)(() => new Vector3());
  const [irisLeftLookAt] = (0, import_react24.useState)(() => new Vector3());
  const computeTarget = (0, import_react24.useCallback)(() => {
  ...
  const [current] = (0, import_react24.useState)(() => new Object3D());
  const update2 = (0, import_react24.useCallback)(function(delta, target3) {
    if (explCamera) {
      var _target;
  ...
  const videoTextureRef = (0, import_react24.useRef)(null);
  const [_faceLandmarkerResult, setFaceLandmarkerResult] = (0, import_react24.useState)();
  const faceLandmarker = useFaceLandmarker();
  const onVideoFrame = (0, import_react24.useCallback)((now, metadata) => {
  ...
  const api = (0, import_react24.useMemo)(() => Object.assign(Object.create(EventDispatcher.prototype), {
    computeTarget,
    update: update2,
    facemeshApiRef
  }), [computeTarget, update2]);
  (0, import_react24.useImperativeHandle)(fref, () => api, [api]);
  ...
  return React140.createElement(FaceControlsContext.Provider, {
    value: api
  }, !manualDetect && React140.createElement(import_react24.Suspense, {
    fallback: null
...
var useFaceControls = () => (0, import_react24.useContext)(FaceControlsContext);
export {
  AccumulativeShadows,
  AdaptiveDpr,
  AdaptiveEvents,
