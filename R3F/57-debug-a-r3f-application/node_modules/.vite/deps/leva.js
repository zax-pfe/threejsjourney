  ...
  "node_modules/prop-types/factoryWithTypeCheckers.js"(exports, module) {
    ...
    module.exports = function(isValidElement7, throwOnDirectAccess) {
      ...
      function createChainableTypeChecker(validate) {
        ...
        function checkType(isRequired, props3, propName, componentName, location2, propFullName, secret) {
          ...
          if (props3[propName] == null) {
            ...
            return validate(props3, propName, componentName, location2, propFullName);
          }
        }
      ...
      function createPrimitiveTypeChecker(expectedType) {
        function validate(props3, propName, componentName, location2, propFullName, secret) {
      ...
      function createArrayOfTypeChecker(typeChecker) {
        function validate(props3, propName, componentName, location2, propFullName) {
      ...
      function createUnionTypeChecker(arrayOfTypeCheckers) {
        ...
        function validate(props3, propName, componentName, location2, propFullName) {
          ...
          for (var i5 = 0; i5 < arrayOfTypeCheckers.length; i5++) {
            ...
            var checkerResult = checker2(props3, propName, componentName, location2, propFullName, ReactPropTypesSecret);
