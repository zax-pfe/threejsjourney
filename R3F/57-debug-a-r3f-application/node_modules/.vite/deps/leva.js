import {
  q,
  require_prop_types
} from "./chunk-3SLIKVHZ.js";
import {
  useDrag
} from "./chunk-Y43X7CCZ.js";
import {
  require_jsx_runtime
} from "./chunk-HTM3RKXN.js";
import {
  require_client
} from "./chunk-KIGIFSI4.js";
import {
  require_react_dom
} from "./chunk-RBP34AY7.js";
import {
  require_react
} from "./chunk-GRDGXRRC.js";
import {
  __commonJS,
  __toESM
...
function createSlot(ownerName) {
  ...
  const Slot22 = React2.forwardRef((props3, forwardedRef) => {
...
function createSlotClone(ownerName) {
  const SlotClone = React2.forwardRef((props3, forwardedRef) => {
    let { children, ...slotProps } = props3;
    if (isLazyComponent(children) && typeof use === "function") {
      children = use(children._payload);
    }
...
function createSlot2(ownerName) {
  ...
  const Slot22 = React7.forwardRef((props3, forwardedRef) => {
...
function createSlotClone2(ownerName) {
  const SlotClone = React7.forwardRef((props3, forwardedRef) => {
    const { children, ...slotProps } = props3;
    if (React7.isValidElement(children)) {
      ...
      return React7.cloneElement(children, props22);
    }
...
var Primitive2 = NODES2.reduce((primitive, node) => {
  ...
  const Node2 = React8.forwardRef((props3, forwardedRef) => {
    const { asChild, ...primitiveProps } = props3;
    const Comp = asChild ? Slot7 : node;
    if (typeof window !== "undefined") {
      window[Symbol.for("radix-ui")] = true;
...
var DismissableLayerBranch = React11.forwardRef((props3, forwardedRef) => {
  const context = React11.useContext(DismissableLayerContext);
  ...
  return (0, import_jsx_runtime7.jsx)(Primitive2.div, { ...props3, ref: composedRefs });
});
...
function createSlot3(ownerName) {
  ...
  const Slot22 = React14.forwardRef((props3, forwardedRef) => {
    const { children, ...slotProps } = props3;
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime8.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React14.isValidElement(newElement) ? React14.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function createSlotClone3(ownerName) {
  const SlotClone = React14.forwardRef((props3, forwardedRef) => {
    const { children, ...slotProps } = props3;
    if (React14.isValidElement(children)) {
      ...
      return React14.cloneElement(children, props22);
    }
...
var Primitive3 = NODES3.reduce((primitive, node) => {
  ...
  const Node2 = React15.forwardRef((props3, forwardedRef) => {
    const { asChild, ...primitiveProps } = props3;
    const Comp = asChild ? Slot7 : node;
    if (typeof window !== "undefined") {
      window[Symbol.for("radix-ui")] = true;
...
var NAME = "Arrow";
var Arrow = React16.forwardRef((props3, forwardedRef) => {
  ...
  return (0, import_jsx_runtime10.jsx)(
    Primitive3.svg,
    {
      ...
      children: props3.asChild ? children : (0, import_jsx_runtime10.jsx)("polygon", { points: "0,0 30,0 15,10" })
    }
  );
});
...
function createSlot4(ownerName) {
  ...
  const Slot22 = React17.forwardRef((props3, forwardedRef) => {
    const { children, ...slotProps } = props3;
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime11.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React17.isValidElement(newElement) ? React17.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function createSlotClone4(ownerName) {
  const SlotClone = React17.forwardRef((props3, forwardedRef) => {
    const { children, ...slotProps } = props3;
    if (React17.isValidElement(children)) {
      ...
      return React17.cloneElement(children, props22);
    }
...
function isSlottable4(child) {
  return React17.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER4;
}
...
var Primitive4 = NODES4.reduce((primitive, node) => {
  ...
  const Node2 = React18.forwardRef((props3, forwardedRef) => {
    const { asChild, ...primitiveProps } = props3;
    const Comp = asChild ? Slot7 : node;
    if (typeof window !== "undefined") {
      window[Symbol.for("radix-ui")] = true;
...
var PopperAnchor = React20.forwardRef(
  (props3, forwardedRef) => {
    ...
    return virtualRef ? null : (0, import_jsx_runtime13.jsx)(Primitive4.div, { ...anchorProps, ref: composedRefs });
  }
);
...
var PopperArrow = React20.forwardRef(function PopperArrow2(props3, forwardedRef) {
...
function createSlot5(ownerName) {
  ...
  const Slot22 = React21.forwardRef((props3, forwardedRef) => {
    const { children, ...slotProps } = props3;
...
function createSlotClone5(ownerName) {
  const SlotClone = React21.forwardRef((props3, forwardedRef) => {
    const { children, ...slotProps } = props3;
    if (React21.isValidElement(children)) {
      const childrenRef = getElementRef5(children);
      const props22 = mergeProps5(slotProps, children.props);
      if (children.type !== React21.Fragment) {
        props22.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
      }
      return React21.cloneElement(children, props22);
    }
...
var Primitive5 = NODES5.reduce((primitive, node) => {
  ...
  const Node2 = React22.forwardRef((props3, forwardedRef) => {
    const { asChild, ...primitiveProps } = props3;
    const Comp = asChild ? Slot7 : node;
    if (typeof window !== "undefined") {
      window[Symbol.for("radix-ui")] = true;
...
var Portal2 = React23.forwardRef((props3, forwardedRef) => {
  var _a;
  const { container: containerProp, ...portalProps } = props3;
  const [mounted, setMounted] = React23.useState(false);
  useLayoutEffect2(() => setMounted(true), []);
  const container = containerProp || mounted && ((_a = globalThis == null ? void 0 : globalThis.document) == null ? void 0 : _a.body);
  return container ? import_react_dom3.default.createPortal((0, import_jsx_runtime16.jsx)(Primitive5.div, { ...portalProps, ref: forwardedRef }), container) : null;
});
Portal2.displayName = PORTAL_NAME2;
...
var useReactEffectEvent = React26[" useEffectEvent ".trim().toString()];
var useReactInsertionEffect = React26[" useInsertionEffect ".trim().toString()];

// node_modules/@radix-ui/react-use-controllable-state/dist/index.mjs
var useInsertionEffect = React27[" useInsertionEffect ".trim().toString()] || useLayoutEffect2;
function useControllableState({
  ...
  if (true) {
    const isControlledRef = React27.useRef(prop !== void 0);
    React27.useEffect(() => {
...
function createSlot6(ownerName) {
  ...
  const Slot22 = React29.forwardRef((props3, forwardedRef) => {
    const { children, ...slotProps } = props3;
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime17.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React29.isValidElement(newElement) ? React29.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function createSlotClone6(ownerName) {
  const SlotClone = React29.forwardRef((props3, forwardedRef) => {
    const { children, ...slotProps } = props3;
    if (React29.isValidElement(children)) {
      const childrenRef = getElementRef7(children);
      const props22 = mergeProps6(slotProps, children.props);
...
function isSlottable6(child) {
  return React29.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER6;
}
...
var Primitive6 = NODES6.reduce((primitive, node) => {
  ...
  const Node2 = React30.forwardRef((props3, forwardedRef) => {
    const { asChild, ...primitiveProps } = props3;
    const Comp = asChild ? Slot7 : node;
    if (typeof window !== "undefined") {
      window[Symbol.for("radix-ui")] = true;
...
var TooltipPortal = (props3) => {
  ...
  return (0, import_jsx_runtime20.jsx)(PortalProvider, { scope: __scopeTooltip, forceMount, children: (0, import_jsx_runtime20.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime20.jsx)(Portal2, { asChild: true, container, children }) }) });
};
...
var TooltipContentHoverable = React32.forwardRef((props3, forwardedRef) => {
  const context = useTooltipContext(CONTENT_NAME2, props3.__scopeTooltip);
  ...
  return (0, import_jsx_runtime20.jsx)(TooltipContentImpl, { ...props3, ref: composedRefs });
});
...
function _objectWithoutProperties(e3, t3) {
  if (null == e3) return {};
  var o3, r3, i3 = _objectWithoutPropertiesLoose(e3, t3);
  if (Object.getOwnPropertySymbols) {
    var n3 = Object.getOwnPropertySymbols(e3);
    for (r3 = 0; r3 < n3.length; r3++) o3 = n3[r3], -1 === t3.indexOf(o3) && {}.propertyIsEnumerable.call(e3, o3) && (i3[o3] = e3[o3]);
  }
  return i3;
}
...
function evaluate2(expr) {
  ...
  if (exp.test(expr)) {
    return evaluate2(expr.replace(exp, (_2, a3, b3) => Math.pow(Number(a3), Number(b3)).toString()));
  }
  if (muldiv.test(expr)) {
    return evaluate2(expr.replace(muldiv, (_2, a3, op, b3) => op === "*" ? (Number(a3) * Number(b3)).toString() : Number(b3) === 0 ? (() => {
      throw new Error("Division by zero");
    })() : (Number(a3) / Number(b3)).toString()));
  }
  if (addsub.test(expr)) {
    return evaluate2(expr.replace(addsub, (_2, a3, op, b3) => op === "+" ? (Number(a3) + Number(b3)).toString() : (Number(a3) - Number(b3)).toString()));
  }
  return Number(expr);
}
...
function ValueInput(_ref) {
  ...
  return import_react2.default.createElement(InputContainer, {
    textArea: isTextArea
  }, innerLabel && typeof innerLabel === "string" ? import_react2.default.createElement(InnerLabel, null, innerLabel) : innerLabel, import_react2.default.createElement(StyledInput, _extends({
    levaType: type,
    ref: inputRef,
    id: inputId,
    type: inputType,
...
function NumberInput(_ref2) {
  ...
  const _onUpdate = (0, import_react2.useCallback)((v3) => onUpdate(parseNumber(v3)), [onUpdate]);
  ...
  return import_react2.default.createElement(ValueInput, _extends({}, props3, {
    onUpdate: _onUpdate,
    onKeyDown,
    type: "number"
  }));
...
function RawLabel(props3) {
  ...
  return import_react2.default.createElement(import_react2.default.Fragment, null, optional2 && import_react2.default.createElement(OptionalToggle, null), hint !== void 0 ? import_react2.default.createElement(Root32, null, import_react2.default.createElement(Trigger, {
    asChild: true
  }, import_react2.default.createElement(StyledLabel, _extends({
    htmlFor: htmlForProp
  }, props3))), import_react2.default.createElement(Content2, {
    side: "top",
    sideOffset: 2
  }, import_react2.default.createElement(StyledToolTipContent, null, hint, import_react2.default.createElement(ToolTipArrow, null)))) : import_react2.default.createElement(StyledLabel, _extends({
    htmlFor: htmlForProp,
    title: titleProp
  }, props3)));
}
...
function useInputSetters({
  ...
  const setFormat = (0, import_react2.useCallback)((v3) => setDisplayValue(format$2(type, v3, settingsRef.current)), [type]);
...
function RangeSlider({
  ...
  return import_react2.default.createElement(RangeWrapper, _extends({
    ref
...
var DraggableLabel = import_react2.default.memo(({
  ...
  return import_react2.default.createElement(InnerNumberLabel, _extends({
    dragging,
...
function NumberComponent() {
  ...
  return import_react2.default.createElement(Row, {
    ...
    hasRange
  }, hasRange && import_react2.default.createElement(RangeSlider, _extends({
    value: parseFloat(value),
    onDrag: onUpdate
  }, settings)), import_react2.default.createElement(Number$1, _extends({}, props3, {
    id,
    label: "value",
...
function Select({
  ...
  return import_react2.default.createElement(SelectContainer, null, import_react2.default.createElement(NativeSelect, {
    ...
    disabled
  }, keys.map((key, index2) => import_react2.default.createElement("option", {
    key,
    value: index2
...
function String$1(_ref) {
  ...
  if (editable) return import_react2.default.createElement(ValueInput, _extends({
    value: displayValue,
    onUpdate,
    onChange
  }, props3));
...
function StringComponent() {
  ...
  return import_react2.default.createElement(Row, {
    input: true
  }, import_react2.default.createElement(Label, null, label), import_react2.default.createElement(String$1, _extends({
    displayValue,
    onUpdate,
    onChange
  }, settings)));
...
function Vector({
  ...
  }), Object.keys(value).map((key, i3) => import_react2.default.createElement(Coordinate, {
    id: i3 === 0 ? id : `${id}.${key}`,
    key,
    valueKey: key,
    value,
...
function i2(e3) {
  var t3 = (0, import_react5.useRef)(e3), n3 = (0, import_react5.useRef)(function(e4) {
...
var m2 = import_react5.default.memo(function(o3) {
  var a3 = o3.onMove, l3 = o3.onKey, s3 = c2(o3, ["onMove", "onKey"]), m3 = (0, import_react5.useRef)(null), g3 = i2(a3), p3 = i2(l3), b3 = (0, import_react5.useRef)(null), _2 = (0, import_react5.useRef)(false), x2 = (0, import_react5.useMemo)(function() {
    var e3 = function(e4) {
  ...
  return (0, import_react5.useEffect)(function() {
    return H2;
  }, [H2]), import_react5.default.createElement("div", u2({}, s3, { onTouchStart: C, onMouseDown: C, className: "react-colorful__interactive", ref: m3, onKeyDown: E, tabIndex: 0, role: "slider" }));
});
var g2 = function(e3) {
...
var p2 = function(r3) {
  ...
  return import_react5.default.createElement("div", { className: l3, style: { top: 100 * a3 + "%", left: 100 * n3 + "%" } }, import_react5.default.createElement("div", { className: "react-colorful__pointer-fill", style: { backgroundColor: t3 } }));
};
...
var S2 = import_react5.default.memo(function(r3) {
  var t3 = r3.hue, n3 = r3.onChange, o3 = g2(["react-colorful__hue", r3.className]);
  return import_react5.default.createElement("div", { className: o3 }, import_react5.default.createElement(m2, { onMove: function(e3) {
    n3({ h: 360 * e3.left });
  }, onKey: function(e3) {
    n3({ h: s2(t3 + 360 * e3.left, 0, 360) });
  }, "aria-label": "Hue", "aria-valuenow": b2(t3), "aria-valuemax": "360", "aria-valuemin": "0" }, import_react5.default.createElement(p2, { className: "react-colorful__hue-pointer", left: t3 / 360, color: q2({ h: t3, s: 100, v: 100, a: 1 }) })));
});
var T = import_react5.default.memo(function(r3) {
  var t3 = r3.hsva, n3 = r3.onChange, o3 = { backgroundColor: q2({ h: t3.h, s: 100, v: 100, a: 1 }) };
  return import_react5.default.createElement("div", { className: "react-colorful__saturation", style: o3 }, import_react5.default.createElement(m2, { onMove: function(e3) {
    n3({ s: 100 * e3.left, v: 100 - 100 * e3.top });
  }, onKey: function(e3) {
    n3({ s: s2(t3.s + 100 * e3.left, 0, 100), v: s2(t3.v - 100 * e3.top, 0, 100) });
  }, "aria-label": "Color", "aria-valuetext": "Saturation " + b2(t3.s) + "%, Brightness " + b2(t3.v) + "%" }, import_react5.default.createElement(p2, { className: "react-colorful__saturation-pointer", top: 1 - t3.v / 100, left: t3.s / 100, color: q2(t3) })));
});
...
function Y(e3, t3, l3) {
  var u3 = i2(l3), c3 = (0, import_react5.useState)(function() {
    return e3.toHsva(t3);
  }), s3 = c3[0], f3 = c3[1], v3 = (0, import_react5.useRef)({ color: t3, hsva: s3 });
  (0, import_react5.useEffect)(function() {
    if (!e3.equal(t3, v3.current.color)) {
      var r3 = e3.toHsva(t3);
      v3.current = { hsva: r3, color: t3 }, f3(r3);
    }
  }, [t3, e3]), (0, import_react5.useEffect)(function() {
    var r3;
    F(s3, v3.current.hsva) || e3.equal(r3 = e3.fromHsva(s3), v3.current.color) || (v3.current = { hsva: s3, color: r3 }, u3(r3));
  }, [s3, e3, u3]);
  var d3 = (0, import_react5.useCallback)(function(e4) {
    f3(function(r3) {
...
var R;
var V = "undefined" != typeof window ? import_react5.useLayoutEffect : import_react5.useEffect;
var $2 = function() {
...
var U = function(t3) {
  var n3 = t3.className, o3 = t3.colorModel, a3 = t3.color, l3 = void 0 === a3 ? o3.defaultColor : a3, i3 = t3.onChange, s3 = c2(t3, ["className", "colorModel", "color", "onChange"]), f3 = (0, import_react5.useRef)(null);
  Q(f3);
  var v3 = Y(o3, l3, i3), d3 = v3[0], h3 = v3[1], m3 = g2(["react-colorful", n3]);
  return import_react5.default.createElement("div", u2({}, s3, { ref: f3, className: m3 }), import_react5.default.createElement(T, { hsva: d3, onChange: h3 }), import_react5.default.createElement(S2, { hue: d3.h, onChange: h3, className: "react-colorful__last-control" }));
};
var ee = function(r3) {
  ...
  return import_react5.default.createElement("div", { className: l3 }, import_react5.default.createElement("div", { className: "react-colorful__alpha-gradient", style: a3 }), import_react5.default.createElement(m2, { onMove: function(e3) {
    o3({ a: e3.left });
  }, onKey: function(e3) {
    o3({ a: s2(n3.a + e3.left) });
  }, "aria-label": "Alpha", "aria-valuetext": u3 + "%", "aria-valuenow": u3, "aria-valuemin": "0", "aria-valuemax": "100" }, import_react5.default.createElement(p2, { className: "react-colorful__alpha-pointer", left: n3.a, color: k2(n3) })));
};
var re = function(t3) {
  var n3 = t3.className, o3 = t3.colorModel, a3 = t3.color, l3 = void 0 === a3 ? o3.defaultColor : a3, i3 = t3.onChange, s3 = c2(t3, ["className", "colorModel", "color", "onChange"]), f3 = (0, import_react5.useRef)(null);
  Q(f3);
  var v3 = Y(o3, l3, i3), d3 = v3[0], h3 = v3[1], m3 = g2(["react-colorful", n3]);
  return import_react5.default.createElement("div", u2({}, s3, { ref: f3, className: m3 }), import_react5.default.createElement(T, { hsva: d3, onChange: h3 }), import_react5.default.createElement(S2, { hue: d3.h, onChange: h3 }), import_react5.default.createElement(ee, { hsva: d3, onChange: h3, className: "react-colorful__last-control" }));
};
var xe = { defaultColor: { r: 0, g: 0, b: 0, a: 1 }, toHsva: L, fromHsva: I2, equal: F };
var Ce = function(r3) {
  return import_react5.default.createElement(re, u2({}, r3, { colorModel: xe }));
};
...
var Ne = function(r3) {
  return import_react5.default.createElement(U, u2({}, r3, { colorModel: Me }));
};
...
function create(createState) {
  ...
  const useStore = (selector = api.getState, equalityFn = Object.is) => {
    const [, forceUpdate] = (0, import_react7.useReducer)((c3) => c3 + 1, 0);
    ...
    (0, import_react7.useDebugValue)(sliceToReturn);
...
function useDeepMemo(fn, deps) {
  ...
  return (0, import_react8.useMemo)(fn, (_useCompareMemoize = useCompareMemoize(deps, true)) !== null && _useCompareMemoize !== void 0 ? _useCompareMemoize : []);
}
...
function Color({
  ...
  }), shown && import_react8.default.createElement(Portal3, null, import_react8.default.createElement(Overlay, {
...
function Joystick({
  ...
  return import_react8.default.createElement(JoystickTrigger, _extends({
    ref: joystickeRef
  }, bind()), joystickShown && import_react8.default.createElement(Portal3, null, import_react8.default.createElement(JoystickPlayground, {
    ref: playgroundRef,
    isOutOfBounds
...
function ImageComponent() {
  ...
  const clear = (0, import_react8.useCallback)((e3) => {
    e3.stopPropagation();
    onUpdate(void 0);
  }, [onUpdate]);
  const {
  ...
  }), shown && !!value && import_react8.default.createElement(Portal3, null, import_react8.default.createElement(Overlay, {
    onPointerUp: hide4,
    style: {
      cursor: "pointer"
    }
...
var Store = function Store2() {
  ...
  this.getVisiblePaths = () => {
    ...
    Object.entries(folders).forEach(([path, settings]) => {
      if (settings.render && paths.some((p3) => p3.indexOf(path) === 0) && !settings.render(this.get)) hiddenFolders.push(path + ".");
    });
    const visiblePaths = [];
...
var LevaCore = import_react8.default.memo(({
  ...
  globalStyles();
  return import_react8.default.createElement(Provider, null, import_react8.default.createElement(PanelSettingsContext.Provider, {
    value: {
    ...
    if (isGlobalPanel && !rootInitialized) {
      if (!rootEl) {
        ...
        if (document.body) {
          ...
          (0, import_client.createRoot)(rootEl).render(import_react8.default.createElement(Leva, {
            isRoot: true
          }));
        }
      }
