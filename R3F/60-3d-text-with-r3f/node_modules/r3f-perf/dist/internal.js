...
class GLPerf {
  ...
  nextFps(d) {
    ...
    if (overLimitFps.isOverLimit < 25) {
      ...
      store.setPerf({ overclockingFps: true });
    }
  }
  /**
   * Increase frameID
  ...
  nextFrame(now) {
    ...
    if (this.frameId <= 1) {
      ...
      if (t >= this.paramTime) {
        ...
        const fps = store.getPerf().overclockingFps ? overLimitFps.value : fpsFixed;
        ...
        if (this.overClock && typeof window.requestIdleCallback !== "undefined") {
          if (overLimitFps.isOverLimit > 0 && fps > fpsFixed) {
            overLimitFps.isOverLimit--;
          } else if (store.getPerf().overclockingFps) {
        ...
        if (this.overClock) {
          if (t - this.lastCalculateFixed >= 2 * 1e3) {
            ...
            store.setPerf({ fpsLimit: overLimitFps.fpsLimit / 10 });
...
exports.GLPerf = GLPerf;
exports.overLimitFps = overLimitFps;
